...
QMAKE_CXXFLAGS += -std=c++14 -msse2 -w -Wno-deprecated-declarations
QMAKE_CFLAGS += -msse2
...
macx:ICON = src/qt/res/icons/oldagehomecoin.icns
macx:TARGET = "OldAgeHomeCoin-Qt"
